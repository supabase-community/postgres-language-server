...
export function getCommand(): string | null {
	...
	> = {
		win32: {
			...
			arm64:
				"@postgres-language-server/cli-aarch64-windows-msvc/postgres-language-server.exe",
		},
		darwin: {
			x64: "@postgres-language-server/cli-x86_64-apple-darwin/postgres-language-server",
			arm64:
				"@postgres-language-server/cli-aarch64-apple-darwin/postgres-language-server",
		},
		linux: {
			x64: "@postgres-language-server/cli-x86_64-linux-gnu/postgres-language-server",
			arm64:
				"@postgres-language-server/cli-aarch64-linux-gnu/postgres-language-server",
		},
		"linux-musl": {
