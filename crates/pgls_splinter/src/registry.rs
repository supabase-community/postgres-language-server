...
pub fn get_sql_file_path(rule_name: &str) -> Option<&'static str> {
    match rule_name {
        ...
        "rlsPolicyAlwaysTrue" => Some("vendor/security/rls_policy_always_true.sql"),
        ...
        "sensitiveColumnsExposed" => Some("vendor/security/sensitive_columns_exposed.sql"),
...
pub fn get_sql_content(rule_name: &str) -> Option<&'static str> {
    match rule_name {
        ...
        "rlsPolicyAlwaysTrue" => Some(include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/",
            "vendor/security/rls_policy_always_true.sql"
        ))),
        ...
        "sensitiveColumnsExposed" => Some(include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/",
            "vendor/security/sensitive_columns_exposed.sql"
        ))),
...
pub fn get_rule_category(rule_name: &str) -> Option<&'static ::pgls_diagnostics::Category> {
    match rule_name {
        ...
        "rls_policy_always_true" => Some(::pgls_diagnostics::category!(
        ...
        "sensitive_columns_exposed" => Some(::pgls_diagnostics::category!(
