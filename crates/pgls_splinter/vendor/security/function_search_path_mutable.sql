-- meta: name = functionSearchPathMutable
-- meta: title = Function Search Path Mutable
-- meta: severity = WARN
-- meta: category = SECURITY
-- meta: description = Detects functions where the search_path parameter is not set.
-- meta: remediation = https://supabase.com/docs/guides/database/database-linter?lint=0011_function_search_path_mutable
