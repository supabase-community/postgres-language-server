-- meta: name = unsupportedRegTypes
-- meta: title = Unsupported reg types
-- meta: severity = WARN
-- meta: category = SECURITY
-- meta: description = Identifies columns using unsupported reg* types outside pg_catalog schema, which prevents database upgrades using pg_upgrade.
-- meta: remediation = https://supabase.com/docs/guides/database/database-linter?lint=unsupported_reg_types
