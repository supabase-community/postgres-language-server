-- meta: name = unusedIndex
-- meta: title = Unused Index
-- meta: severity = INFO
-- meta: category = PERFORMANCE
-- meta: description = Detects if an index has never been used and may be a candidate for removal.
-- meta: remediation = https://supabase.com/docs/guides/database/database-linter?lint=0005_unused_index
