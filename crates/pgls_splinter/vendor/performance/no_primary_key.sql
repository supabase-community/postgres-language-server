-- meta: name = noPrimaryKey
-- meta: title = No Primary Key
-- meta: severity = INFO
-- meta: category = PERFORMANCE
-- meta: description = Detects if a table does not have a primary key. Tables without a primary key can be inefficient to interact with at scale.
-- meta: remediation = https://supabase.com/docs/guides/database/database-linter?lint=0004_no_primary_key
