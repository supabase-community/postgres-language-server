-- meta: name = tableBloat
-- meta: title = Table Bloat
-- meta: severity = INFO
-- meta: category = PERFORMANCE
-- meta: description = Detects if a table has excess bloat and may benefit from maintenance operations like vacuum full or cluster.
-- meta: remediation = Consider running vacuum full (WARNING: incurs downtime) and tweaking autovacuum settings to reduce bloat.
