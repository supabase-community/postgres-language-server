...
module.exports = grammar({
  ...
  rules: {
    ...
    cte: ($) =>
      seq(
        $.identifier,
        optional(paren_list(field("argument", $.identifier), false)),
        $.keyword_as,
    ...
    create_view: ($) =>
      prec.right(
        seq(
          ...
          optional($._if_not_exists),
          $.object_reference,
          optional(paren_list($.identifier, false)),
          $.keyword_as,
          $.create_query,
          optional(
            seq(
    ...
    alter_index: ($) =>
      seq(
        ...
        choice(
          ...
          seq($.keyword_reset, paren_list($.identifier, false)),
          seq(
            $.keyword_set,
            choice(
              seq($.keyword_tablespace, $.identifier),
    ...
    table_partition: ($) =>
      seq(
        ...
        choice(
          paren_list($.identifier, false), // postgres & Impala (CTAS)
