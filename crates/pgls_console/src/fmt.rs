...
/// The [Formatter] is the `pgls_console` equivalent to [std::fmt::Formatter]:
...
/// Formatting trait for types to be displayed as markup, the `pgls_console`
