...
define_categories! {
    ...
    "lint/safety/banAddExclusionConstraint": "https://pg-language-server.com/latest/reference/rules/ban-add-exclusion-constraint/",
    "lint/safety/banAlterEnumAddValue": "https://pg-language-server.com/latest/reference/rules/ban-alter-enum-add-value/",
    "lint/safety/banAttachPartition": "https://pg-language-server.com/latest/reference/rules/ban-attach-partition/",
    "lint/safety/banBlockingRefreshMatview": "https://pg-language-server.com/latest/reference/rules/ban-blocking-refresh-matview/",
    ...
    "lint/safety/banCreateTrigger": "https://pg-language-server.com/latest/reference/rules/ban-create-trigger/",
    ...
    "lint/safety/banEnableDisableTrigger": "https://pg-language-server.com/latest/reference/rules/ban-enable-disable-trigger/",
    "lint/safety/banNotValidValidateSameTransaction": "https://pg-language-server.com/latest/reference/rules/ban-not-valid-validate-same-transaction/",
    ...
    "lint/safety/warnRefreshMatviewConcurrent": "https://pg-language-server.com/latest/reference/rules/warn-refresh-matview-concurrent/",
    "lint/safety/warnWideLockWindow": "https://pg-language-server.com/latest/reference/rules/warn-wide-lock-window/",
    // end lint rules
