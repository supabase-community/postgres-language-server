...
define_categories! {
    ...
    "lint/safety/avoidAddingExclusionConstraint": "https://pg-language-server.com/latest/reference/rules/avoid-adding-exclusion-constraint/",
    "lint/safety/avoidAlterEnumAddValue": "https://pg-language-server.com/latest/reference/rules/avoid-alter-enum-add-value/",
    "lint/safety/avoidAttachingPartition": "https://pg-language-server.com/latest/reference/rules/avoid-attaching-partition/",
    "lint/safety/requireConcurrentRefreshMatview": "https://pg-language-server.com/latest/reference/rules/require-concurrent-refresh-matview/",
    ...
    "lint/safety/avoidCreateTrigger": "https://pg-language-server.com/latest/reference/rules/avoid-create-trigger/",
    "lint/safety/banDeleteWithoutWhere": "https://pg-language-server.com/latest/reference/rules/ban-delete-without-where/",
    ...
    "lint/safety/banDropSchema": "https://pg-language-server.com/latest/reference/rules/ban-drop-schema/",
    "lint/safety/banDropTable": "https://pg-language-server.com/latest/reference/rules/ban-drop-table/",
    "lint/safety/banDropTrigger": "https://pg-language-server.com/latest/reference/rules/ban-drop-trigger/",
    "lint/safety/avoidEnableDisableTrigger": "https://pg-language-server.com/latest/reference/rules/avoid-enable-disable-trigger/",
    "lint/safety/requireSeparateConstraintValidation": "https://pg-language-server.com/latest/reference/rules/require-separate-constraint-validation/",
    "lint/safety/banTruncate": "https://pg-language-server.com/latest/reference/rules/ban-truncate/",
    "lint/safety/banTruncateCascade": "https://pg-language-server.com/latest/reference/rules/ban-truncate-cascade/",
    "lint/safety/banUpdateWithoutWhere": "https://pg-language-server.com/latest/reference/rules/ban-update-without-where/",
    "lint/safety/banVacuumFull": "https://pg-language-server.com/latest/reference/rules/ban-vacuum-full/",
    ...
    "lint/safety/requireConcurrentDetachPartition": "https://pg-language-server.com/latest/reference/rules/require-concurrent-detach-partition/",
    ...
    "lint/safety/requireConcurrentReindex": "https://pg-language-server.com/latest/reference/rules/require-concurrent-reindex/",
    "lint/safety/requireIdleInTransactionTimeout": "https://pg-language-server.com/latest/reference/rules/require-idle-in-transaction-timeout/",
    "lint/safety/requireStatementTimeout": "https://pg-language-server.com/latest/reference/rules/require-statement-timeout/",
    ...
    "lint/safety/concurrentRefreshMatviewLock": "https://pg-language-server.com/latest/reference/rules/concurrent-refresh-matview-lock/",
    "lint/safety/avoidWideLockWindow": "https://pg-language-server.com/latest/reference/rules/avoid-wide-lock-window/",
    // end lint rules
