use pgls_console::fmt::MarkupElements;
use pgls_console::{
...
/// implementing [pgls_console::fmt::Write].
...
mod tests {
    ...
    use pgls_console::{fmt, markup};
    use pgls_diagnostics::{DiagnosticTags, Severity};
    use pgls_diagnostics_categories::{Category, category};
    use pgls_text_edit::TextEdit;
    use pgls_text_size::{TextRange, TextSize};
    use serde_json::{from_value, json};

    use crate::{self as pgls_diagnostics};
    use crate::{
