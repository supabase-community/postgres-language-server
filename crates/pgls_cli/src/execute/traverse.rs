...
use pgls_diagnostics::DiagnosticTags;
use pgls_diagnostics::{DiagnosticExt, Error, Resource, Severity};
...
pub(crate) struct TraverseResult {
    ...
    pub(crate) evaluated_paths: BTreeSet<PgLSPath>,
...
impl TraversalContext for TraversalOptions<'_, '_> {
    ...
    fn can_handle(&self, pgt_path: &PgLSPath) -> bool {
