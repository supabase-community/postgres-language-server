...
impl CompletionScore<'_> {
    ...
    fn check_matches_query_input(&mut self, ctx: &TreesitterContext) {
        ...
        let name = match self.data {
            ...
            CompletionRelevanceData::Keyword(kw) => kw.name.to_ascii_lowercase(),
        };
    ...
    fn get_item_name(&self) -> &str {
        match self.data {
            ...
            CompletionRelevanceData::Keyword(kw) => kw.name,
        }
    }
    ...
    fn get_schema_name(&self) -> Option<&str> {
        match self.data {
            ...
            CompletionRelevanceData::Role(_) | CompletionRelevanceData::Keyword(_) => None,
        }
    }
